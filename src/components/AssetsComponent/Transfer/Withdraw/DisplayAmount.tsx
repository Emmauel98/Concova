...
const DisplayAmount = ({
  modalVisbleForWithdrawDetails,
  setModalVisibleForWithdrawDetails,
  setModalVisibleForWithdrawPasscode,
}: {
  modalVisbleForWithdrawDetails: boolean;
  setModalVisibleForWithdrawDetails: (value: boolean) => void;
  setModalVisibleForWithdrawPasscode: (value: boolean) => void;
}) => {
  const { withdrawAmount } = useMainAppContextFunc();
  ...
  return (
    <View>
      <Modal
        animationType="slide"
        transparent={true}
        visible={modalVisbleForWithdrawDetails}
      >
        <View className="h-screen w-screen bg-[#0000007c] pt-[60vh]">
          <View className="pb-[5vh] pt-[5vh]  bg-[#05070D] shadow-sm shadow-white rounded-3xl">
            ...
            <View className=" flex-row justify-center items-center">
              ...
              <TouchableOpacity
                ...
                onPress={() => setModalVisibleForWithdrawDetails(false)}
              >
            ...
            <View className=" flex-row justify-center items-center mt-5">
              <Text className=" text-[40px] font-medium text-white">
                Q {Number(withdrawAmount).toLocaleString()}
              </Text>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setModalVisibleForWithdrawDetails(false);
